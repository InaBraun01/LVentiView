...
df_offset = pd.read_csv('/data.lfpn/ibraun/Code/paper_volume_calculation/Idealized_model/Linear_Interpolation_Results/Linear_Interpolation_offset_MRI_reso_scale.csv')  # Replace with your actual file path
df_no_top = pd.read_csv('/data.lfpn/ibraun/Code/paper_volume_calculation/Idealized_model/Linear_Interpolation_Results/Linear_Interpolation_no_top_MRI_reso_scale.csv')  # Replace with your actual file path
df_all = pd.read_csv('/data.lfpn/ibraun/Code/paper_volume_calculation/Idealized_model/Linear_Interpolation_Results/Linear_Interpolation_all_MRI_reso_scale.csv')  # Replace with your actual file path
...
plt.savefig("/data.lfpn/ibraun/Code/paper_volume_calculation/Idealized_model/Graphics/linear_interp_bp_scaling_factor.pdf", dpi=300, bbox_inches='tight', 
            facecolor='white', edgecolor='none', pad_inches=0.2)
plt.savefig("/data.lfpn/ibraun/Code/paper_volume_calculation/Idealized_model/Graphics/linear_interp_scaling_factor.svg", dpi=300, bbox_inches='tight', 
            facecolor='white', edgecolor='none', pad_inches=0.2)
# plt.show()