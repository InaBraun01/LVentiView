...
colors = {
    'no_top_de': '#2B4168',    # Modern blue
	'no_top_in': '#A1B3D3',      # Modern blue
    'all_slices_de': '#7F0B17',  # JAHA red
	'all_slices_in': '#E57373',  # JAHA red
    'offset_de': "#1C5B3A",      # matching green that also colorblind people can differentiate
	'offset_in': "#6FCF97",      # matching green that also colorblind people can differentiate
...
plt.savefig("/data.lfpn/ibraun/Code/paper_volume_calculation/Idealized_model/Graphics/plot_calculated_bp_vol_decrease_increase.pdf", dpi=300, bbox_inches='tight', 
