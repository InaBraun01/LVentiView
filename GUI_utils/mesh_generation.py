...
def calculate_segmentation_uncertainty_step(de, log_func=print):
    log_func("Calculating Segmentation Uncertainty ...")
    calculate_segmentation_uncertainty(de, 'mesh')
    return os.path.join(de.folder['mesh_seg_uncertainty']) # or correct folder!