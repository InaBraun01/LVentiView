...
class DicomAnalysisApp(QWidget):
    ...
    def create_header(self, main_layout):
        ...
        <div style="background: #f8f9fa; padding: 12px; border-radius: 6px; margin-bottom: 15px; border-left: 4px solid #4A90E2;">
            ...
            <ul style="margin: 0; padding-left: 25px; font-size: 12px;">
                ...
                <li style="margin-bottom: 6px;"><strong>Crop size:</strong> Size of the region cropped around the left ventricle in each MRI image.</li>
            </ul>
        </div>
        ...
        <div style="background: #f8f9fa; padding: 12px; border-radius: 6px; margin-bottom: 15px; border-left: 4px solid #4A90E2;">
            <ul style="margin: 0; padding-left: 25px; font-size: 12px;">
                <li style="margin-bottom: 6px;"><strong>Analysis_Simpson_Method/Segmentation_Mask/simpson_volumes.csv:</strong> Myocardium and Blood Pool Volume calculated using Simpson's method</li>
                <li style="margin-bottom: 6px;"><strong>Analysis_Simpson_Method/Segmentation_Mask/simpson_volumes.csv:</strong> ED and ES state derived from volumes calculated using Simpson's method</li>
                <li style="margin-bottom: 6px;"><strong>Analysis_Simpson_Method/Segmentation_Mask/Plots/:</strong>Folder containing blood pool and myocardum volume plotted over the cardiac cycle</li>
                <li style="margin-bottom: 6px;"><strong>DicomExam.pickle:</strong> Pickle containing segmented MRI data</li>
            </ul>
        </div>
    ...
    def create_parameters_section(self):
        ...
        clean_params = [
            ...
            ('slice_threshold', 'Exclusion threshold of missing slices', '2'),
            ('crop_size','Crop Size', '')
        ]
    ...
    def get_clean_params(self):
        ...
        for key, widget in self.param_fields.items():
            ...
            elif key in ['slice_threshold', 'crop_size']:
                try:
                    params[key] = int(text)
                except ValueError:
