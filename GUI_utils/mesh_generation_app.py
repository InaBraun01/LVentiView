...
class MeshGenerationApp(QWidget):
    ...
    def create_header(self):
        ...
        help_content.setHtml("""
            ...
            <p style="margin-bottom: 20px; font-size: 13px;">
            In the following sections, we describe the different parts where manual input is possible or required as well as the outputs that are generated by this module.
            </p>
        ...
        <p style="margin-bottom: 15px; font-size: 13px;">
        This module generates a set of outputs in a folder structure as follows:
        </p>
                             
        <div style="background: #f8f9fa; padding: 12px; border-radius: 6px; margin-bottom: 15px; border-left: 4px solid #4A90E2;">
            <ul style="margin: 0; padding-left: 25px; font-size: 12px;">
                <li style="margin-bottom: 6px;"><strong>Meshes/Coefficients:</strong> CSV files containing coefficients representing the mesh in a reduced-dimensional space, fitted to the MRI images</li>
                <li style="margin-bottom: 6px;"><strong>Meshes/VTK_files:</strong> Each generated mesh saved in VTK format</li>
                <li style="margin-bottom: 6px;"><strong>Meshes/<i>SERIES_NAME</i>_Mesh_Visulization.png:</strong> Visualization of the generated mesh overlaid on the MRI images</li>
                <li style="margin-bottom: 6px;"><strong>Analysis_Meshes/mesh_volumes.csv:</strong> Myocardium and Blood Pool Volume calculated from volumetric meshes</li>
                <li style="margin-bottom: 6px;"><strong>Analysis_Meshes/ED_ES_states.csv:</strong> ED and ES states derived from the generated meshes</li>
                <li style="margin-bottom: 6px;"><strong>Analysis_Meshes/ED_state.vtk and ES_state.vtk :</strong> VTK files containing the ED and ES state meshes</li>
                <li style="margin-bottom: 6px;"><strong>Analysis_Meshes/Plots and ES_state.vtk :</strong> Folder containing plots of blood pool and myocardial volume over the cardiac cycle</li>
                <li style="margin-bottom: 6px;"><strong>all_series_end_dice.csv:</strong> Dice scores between the segmentation masks and the generated mesh for each time step averaged over all series used for fitting</li>
                <li style="margin-bottom: 6px;"><strong><i>SERIES_NAME</i>_end_dice.csv:</strong> Dice scores between the segmentation masks and the generated mesh for each time step for the specific series</li>
            </ul>
        </div>
    ...
    def on_mesh_visual_ready(self, plot_folder):
        try:
            ...
            csv_path = os.path.join(dir_name, "all_series_end_dice.csv")  # Need to still replace this, so that it works
